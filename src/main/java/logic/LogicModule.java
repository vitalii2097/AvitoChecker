        ...
        switch(message.toLowerCase()) {
            ...
            case "help" : {
                conversation.send("*Avito Notifier by VEP*\n" +
                        ...
                        "название категории:\n" +
                        "    1) _Ultra_ - профит от 10.000р и выше\n" +
                        "    2) _High_ - профит от 5.000р и выше\n" +
                        "    3) _Medium_ - профит от 3.000р и выше\n" +
                        "    4) _Low_ - профит от 0р и выше\n" +
                        "    5) _All_ - вывод абсолютно всех объявлений");
                break;
            }
            case "hello":
            case "привет": {
