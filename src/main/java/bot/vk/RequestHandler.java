...
class RequestHandler extends AbstractHandler {
    ...
    public RequestHandler(String confirmationCode, VkBot bot) {
        this.bot = bot;
            ...
            switch (type) {
                ...
                case MESSAGE_TYPE:
                    ...
                    if (!conversationMap.containsKey(userId)) {
                        VkConversation conversation = new VkConversation(bot, userId);
                        conversationMap.put(userId, conversation);
                        bot.addConversation(conversation);
                    }

                    VkConversation vkConversation = conversationMap.get(userId);
                    vkConversation.notifyAboutNewMessage(message);
